...
import InquiryWithoutAsset from '@/components/Inquiry/InquiryWithoutAsset';
  ...
  return (
    <>
      ...
      <section className={styles.guideContainer}>
        <div className={`${styles.contentContainer} ${styles.guide}`}>
          ...
          <div className={styles.descriptionContainer}>
            <div className={styles.descTitle}><span className={styles.noFont}>ー</span>　こんな方におすすめです　<span className={styles.noFont}>ー</span></div>
